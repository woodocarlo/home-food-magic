...
function Testimonials() {
  ...
  return (
    <section ref={ref} className="py-16 bg-[url('https://images.unsplash.com/photo-1556911220-bff31c812dba?q=80&w=1920&auto=format&fit=crop')] bg-cover bg-center bg-no-repeat relative">
